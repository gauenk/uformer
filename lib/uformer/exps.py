...
def exps_compare_attn_modes(iexps=None):
    ...
    expl['ps'] = [7]
    expl['flow'] = ['true']
    expl['attn_mode'] = ['product_stnls','l2_stnls'] # todo: "ca_squeeze" and "channel"
...
def exps_motivate_paper(iexps=None):
    ...
    # # expl['stride0'] = [4]
    # # expl['stride1'] = [4]
    # # expl['attn_mode'] = ['product_stnls'] # too slow
    # expl['attn_mode'] = ['pd-w-w-w-w']
    # expl['freeze'] = ["f-f-t-t-t"]
    # expl['filter_by_attn_post'] = ["true"]
    # exps += cache_io.mesh_pydicts(expl)
...
def exps_rgb_denoising_train(iexps=None):
    ...
    # -- [exp l:10] --
    expl['num_heads'] = ['1-2-4-8-16']
    expl['in_attn_mode'] = ["pd-pd-pd-pd-pd"]
    expl['attn_mode'] = ["pd-pd-pd-pd-pd"]
    expl['attn_reset'] = ["true"]
    expl['embed_dim'] = ['24-24-24-24-24']
    expl['stride0'] = ['4-4-2-1-1']
    expl['stride1'] = ['1-1-1-1-1']
    expl['ws'] = ["29-15-9-9-9"]
    expl['wt'] = ["0-0-0-0-0"]
...
def exps_rgb_denoising_test(iexps=None):
    ...
    expl['ps'] = ['7-5-3-3-3']
    expl['model_depths'] = ["1-2-8-8-2"]
    expl['pretrained_path'] = ["2b4d0a80-2521-4dff-9ffa-d163b46b987c"]
    expl['input_proj_depth'] = [1]
    expl['output_proj_depth'] = [1]
    expl['qk_frac'] = ['.25-1-1-1-1']
    expl['rbwd'] = ['true']
    ...
    expl['ps'] = ['7-7-3-3-3']
    expl['model_depths'] = ["1-2-8-8-2"]
    expl['pretrained_path'] = ["7b204601-df7c-4e2c-939e-97186ea06c7c"]
    expl['input_proj_depth'] = [1]
    expl['output_proj_depth'] = [1]
    expl['qk_frac'] = ['.25-.25-1-1-1']
    expl['rbwd'] = ['true']
    ...
    expl['input_proj_depth'] = [1]
    expl['output_proj_depth'] = [1]
    expl['qk_frac'] = ['.25-.25-.25-0.25-0.25']
    expl['rbwd'] = ['true']
    exps += cache_io.mesh_pydicts(expl) # create mesh
